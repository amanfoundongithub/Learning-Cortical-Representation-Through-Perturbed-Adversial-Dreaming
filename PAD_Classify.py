...
dir_files = "./result/cifar10/model_wnf_rem" 
try:
    os.makedirs(dir_files)
except OSError:
    pass

dir_checkpoint = "./checkpoint/cifar10/model_wnf_rem"
try:
...
for epoch in range(n_epochs_c):
    ...
    }, dir_files+'/classifier/accuracies.pth')
...
fig.savefig(dir_files + '/classifier/linear_classif.png', bbox_inches='tight')
